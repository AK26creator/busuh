...
const App: React.FC = () => {
  ...
  // GPS Tracking for driver - automatically tracks location when trip is active and user is driver
  const { error: gpsError, permissionGranted } = useGPSTracking({
    busNumber: trip.busNumber,
    institutionId: institutionId || '',
    isActive: trip.isActive && role === UserRole.DRIVER,
  ...
  const renderView = () => {
    switch (currentView) {
      ...
      case View.ADMIN_DASHBOARD:
        return <AdminDashboard setView={setCurrentView} institutionName="Vidyon Academy" institutionId={institutionId} />;
